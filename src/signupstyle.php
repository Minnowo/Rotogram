...
<tr ><td><div  class="title"><center>Signup</div></td></tr>
<?php
if(isset($msg)){
...
<tr><td><div class="center"><center><input class ="submit"  type="submit" name= "button"   value="Register"></div> </td><td>
<div class="center"><center><input class ="signup"  type="submit" name="signup"  value="Login"></div> </td></tr>
</form>
</table>
</html>
